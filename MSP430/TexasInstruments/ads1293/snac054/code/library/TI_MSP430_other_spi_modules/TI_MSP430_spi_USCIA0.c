...
//******************************************************************************
// Support for 261x USCI_A0
//******************************************************************************
#if TI_ADS1293_SER_INTF == TI_ADS1293_SER_INTF_USCIA0
//------------------------------------------------------------------------------
...
void TI_ADS1293_SPISetup(void)
{
  ...
  UCA0BR1 = 0;
  UCA0MCTL = 0;
  TI_ADS1293_SPI_UCA0_PxSEL1 |= TI_ADS1293_SPI_UCA0_SIMO
                                   | TI_ADS1293_SPI_UCA0_SOMI;              
  TI_ADS1293_SPI_UCA0_PxSEL2 |= TI_ADS1293_SPI_UCA0_UCLK;
                                                                               // SPI option select
  TI_ADS1293_SPI_UCA0_PxDIR1 |= TI_ADS1293_SPI_UCA0_SIMO;
  TI_ADS1293_SPI_UCA0_PxDIR2 |= TI_ADS1293_SPI_UCA0_UCLK;
