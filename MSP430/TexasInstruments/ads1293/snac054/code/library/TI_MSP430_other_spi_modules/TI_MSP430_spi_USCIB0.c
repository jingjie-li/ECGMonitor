...
//******************************************************************************
// Support for 261x USCI_B0
//******************************************************************************
#if TI_ADS1293_SER_INTF == TI_ADS1293_SER_INTF_USCIB0
//------------------------------------------------------------------------------
...
void TI_ADS1293_SPISetup(void)
{
  ...
  TI_ADS1293_SPI_UCB0_PxSEL1 |= TI_ADS1293_SPI_UCB0_SIMO
                                   | TI_ADS1293_SPI_UCB0_SOMI;              
  TI_ADS1293_SPI_UCB0_PxSEL2 |= TI_ADS1293_SPI_UCB0_UCLK;
                                                                               // SPI option select
  TI_ADS1293_SPI_UCB0_PxDIR1 |= TI_ADS1293_SPI_UCB0_SIMO;
  TI_ADS1293_SPI_UCB0_PxDIR2 |= TI_ADS1293_SPI_UCB0_UCLK;
