...
//******************************************************************************
// Support for FRAM 57xx eUSCI_B0
//******************************************************************************
#if TI_ADS1293_SER_INTF == TI_ADS1293_SER_INTF_eUSCIB0_FR57xx
...
void TI_ADS1293_SPISetup(void)
{
  ...
  UCB0CTLW0 |= UCMST+UCCKPL+UCMSB+UCSYNC;                                      // 3-pin, 8-bit SPI master  
  UCB0CTLW0 |= UCSSEL_2;                                                       // SMCLK
  UCB0BRW = 0x04;                                                              // UCLK/4
  
  TI_ADS1293_SPI_eUSCIB0_SIMO_PxSEL1 |= TI_ADS1293_SPI_eUSCIB0_SIMO;           // SPI option select
  TI_ADS1293_SPI_eUSCIB0_SOMI_PxSEL1 |= TI_ADS1293_SPI_eUSCIB0_SOMI;              
  TI_ADS1293_SPI_eUSCIB0_UCLK_PxSEL1 |= TI_ADS1293_SPI_eUSCIB0_UCLK;
  
  TI_ADS1293_SPI_eUSCIB0_SIMO_PxSEL0 &= ~TI_ADS1293_SPI_eUSCIB0_SIMO;            
  TI_ADS1293_SPI_eUSCIB0_SOMI_PxSEL0 &= ~TI_ADS1293_SPI_eUSCIB0_SOMI;              
  TI_ADS1293_SPI_eUSCIB0_UCLK_PxSEL0 &= ~TI_ADS1293_SPI_eUSCIB0_UCLK;  
                                                                               
  TI_ADS1293_SPI_eUSCIB0_SIMO_PxDIR |= TI_ADS1293_SPI_eUSCIB0_SIMO;            // SPI TXD out direction
  TI_ADS1293_SPI_eUSCIB0_UCLK_PxDIR |= TI_ADS1293_SPI_eUSCIB0_UCLK;
