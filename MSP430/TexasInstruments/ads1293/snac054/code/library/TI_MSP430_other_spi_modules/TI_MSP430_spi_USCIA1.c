...
//******************************************************************************
// Support for 261x USCI_A1
//******************************************************************************
#if TI_ADS1293_SER_INTF == TI_ADS1293_SER_INTF_USCIA1
//------------------------------------------------------------------------------
...
void TI_ADS1293_SPISetup(void)
{
  ...
  UCA1BR1 = 0;
  UCA1MCTL = 0;
  TI_ADS1293_SPI_UCA1_PxSEL1 |= TI_ADS1293_SPI_UCA1_SIMO
                                   | TI_ADS1293_SPI_UCA1_SOMI;              
  TI_ADS1293_SPI_UCA1_PxSEL2 |= TI_ADS1293_SPI_UCA1_UCLK;
                                                                               // SPI option select
  TI_ADS1293_SPI_UCA1_PxDIR1 |= TI_ADS1293_SPI_UCA1_SIMO;
  TI_ADS1293_SPI_UCA1_PxDIR2 |= TI_ADS1293_SPI_UCA1_UCLK;
