...
//******************************************************************************
#if TI_ADS1293_SER_INTF == TI_ADS1293_SER_INTF_USCIA0_5xx
...
void TI_ADS1293_SPISetup(void)
{
  ...
  UCA0BR1 = 0;
  UCA0MCTL = 0;
  TI_ADS1293_SPI_USCIA0_PxSEL1 |= TI_ADS1293_SPI_USCIA0_SIMO
                                   | TI_ADS1293_SPI_USCIA0_SOMI;              
  TI_ADS1293_SPI_USCIA0_PxSEL2 |= TI_ADS1293_SPI_USCIA0_UCLK;
                                                                               // SPI option select
  TI_ADS1293_SPI_USCIA0_PxDIR1 |= TI_ADS1293_SPI_USCIA0_SIMO;
  TI_ADS1293_SPI_USCIA0_PxDIR2 |= TI_ADS1293_SPI_USCIA0_UCLK;
